...
Class Element_Embedplaylist_View extends ModuleViewAbstract
{
     ...
     * @var string
     */
    private $meta_name = 'epic_video_cache';

    public function get_youtube_api() {
        return epic_get_option( 'youtube-api', '' );
    }
    ...
    public function get_video_detail($results)
    {
        ...
        if(!empty($youtube))
        {
            $url = 'https://www.googleapis.com/youtube/v3/videos?id=' . implode(',', $youtube) . '&part=id,contentDetails,snippet&key=' . $this->get_youtube_api();
                    ...
                    <div class=\"jeg_video_playlist_list_wrapper\">
                        <div class=\"jeg_video_playlist_current\">
                            <div class=\"jeg_video_playlist_play\">
                                ...
                                <span>" . esc_html__('Currently Playing', 'epic-ne') . "</span>
                            </div>
